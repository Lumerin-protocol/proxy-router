...
type Contract interface {
	...
	GetResourceEstimates() map[string]string // map of resouce quantitative estimates, for example for hashrate this would be map[string]string{"hashrate GH/S": "1000"}
}
...
const (
	ResourceTypeHashrate    ResourceType = "hashrate"
	ResourceTypeVideoStream ResourceType = "video_stream"
